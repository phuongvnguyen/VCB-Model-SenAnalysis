...
# 
# 
# $$\Large \underline{\color{red}{\textbf{BÁO CÁO THỰC HIỆN}}}$$
# 
# 
# 
# $$\Large \color{blue}{\textbf{Giới Thiệu Cách Thức Tính Toán Và Áp Dụng Hơn 35 Chỉ Tiêu }}$$
# $$\Large \color{blue}{\textbf{Và Phương Pháp Theo Chuẩn Mực Quốc Tê Được Sử Dụng }}$$
# $$\Large \color{blue}{\textbf{Cho Qúa Trình Phân Tích Độ Nhạy Trong Việc Đánh Gía }}$$
# $$\Large \color{blue}{\textbf{Và Giám Sát Hoạt Động Của Mô Hình Dự Báo Rủi Ro Vỡ Nợ}}$$
...
# 
# 16. Marco Ratto. Analysing DSGE Models with Global Sensitivity Analysis. Computational Economics
# 
# 17. Adolfson. Bayesian estimation of an open economy DSGE model with incomplete pass-through. Journal of International Economics
# 
# 
# Dưới đây là Bảng Nội dung phân tích
# 
# $\underline{\color{blue}{\textbf{6. Bảng Nội Dung Thực Hiện Dự Án}}}$
# 
...
#  
#  1.  <a href='#EDA'>Khai phá dữ liệu (EDA) </a>   
#  
#  2. <a href='#DataPre_1'>Chuẩn bị dữ liệu </a> 
#  
#  2.1 <a href='#DataPre_1'>Dữ liệu đầu vào </a> 
#  
#  2.2 <a href='#DataPre_2'>Dữ liệu đầu ra </a> 
#    
#  2.3 <a href='#DataPre_33'>Mối quan hệ biến đầu vào và đầu ra </a>
#      
#  2.4 <a href='#DataPre_3'>Phân tách dữ liệu </a> 
#      
#  $$\Large \color{blue}{\textbf{Phần III: Phát Triển Mô Hình}}$$
#  
#  
#  
#  1 <a href='#Train_10'>Xác lập cấu hình và khớp dữ liệu </a> 
#     
#  2 <a href='#Train_1'>Gía trị fitted đầu ra </a> 
#  
...
#  
#  
#  1. <a href='#Train_11'>Phân Tích nghĩa thóng kê của biến giải thích</a> 
#  
#  2. <a href='#Valid_102'>Phân tích Đồ thị Scatter </a> 
#  
#  3. <a href='#Valid_101'>Hiệu Ứng Biên (Phương pháp đạo hàm) </a> 
#     
#  4. <a href='#Valid_1022'>Variance inflation factor</a> 
#  
#  5. <a href='#Valid_101'>Kiểm Định Wald </a> 
#  
#  6. <a href='#Valid_102'>Vai Trò Các Biến Giải Thích </a> 
#  
#  7. <a href='#Valid_100'>Deviance </a> 
#  
#  8. <a href='#Valid_11'>Phân Tích ANOVA( Analysis Of Variance) </a> 
#  
#  9. <a href='#Valid_1012'>Biến Động Gía Trị Likelihood </a> 
#  
#  10. <a href='#Valid_1013'>Biến Động Tỷ số Thống kê Likelihood chi-squared</a> 
#  
#  11. <a href='#Valid_1014'>Biến Động Chỉ Số Pseudo-R-squared</a>
#  
#  12. <a href='#Valid_1015'>Sự phức tạp của Mô Hình</a>
#      
#  13. <a href='#Valid_11'>Phân Tích ANOVA( Analysis Of Variance) </a> 
#     
#  14. <a href='#Valid_12'>Độ Nhạy Của Mô Hình Với Số Biến Giải Thích </a>
#     
#  15. <a href='#Valid_13'>Độ Nhạy Của Mô Hình Với Số Quan Sát </a> 
#     
#  16. <a href='#Valid_133'>Deviance Residual  </a> 
#  
#  17. <a href='#Valid_136'>Log Loss </a> 
#  
#  18. <a href='#Valid_134'>Working Residuals </a> 
#  
#  19. <a href='#Valid_135'>Cook’s Distance </a> 
#    
#  20. <a href='#Valid_1399'>Thống Kê Kolmogorov–Smirnov (KS) </a> 
#    
#  21. <a href='#Valid_134'>Ma Trận Confusion  </a> 
#    
#  22. <a href='#Valid_135'>Chỉ Tiêu AUROC </a> 
#  
#  23. <a href='#Valid_1350'>Bootstrap Analysis AUROC </a> 
#  
#  24. <a href='#Valid_1351'>Khoảng Tin Cậy Cho AUROC </a> 
#    
#  25. <a href='#Valid_136'>Hệ Số Gini (Accuracy Ratio AR) </a> 
#  
#  26. <a href='#Valid_1367'>Bootstrap for Gini (Accuracy Ratio AR) </a> 
#  
#  27. <a href='#in_sam45'>In-sample Prediction Error </a>  
#    
#  28. <a href='#in_sam18'>CAP – Cumulative Accuracy Profile </a> 
#  
#  29. <a href='#in_sample70'>In-Sample Discriminatory Power Của Mô Hình Logistic </a> 
#  
#  30. <a href='#in_sample09'>Lorenz Curve</a> 
#   
#  31. <a href='#in_sample91'>Điểm Brier và Calibration Plots</a> 
#   
#  32. <a href='#insmap1791'>The Information Entropy </a>   
#   
#  33. <a href='#insmap179'>Precision-Recall Curve </a>  
#  
#  34. <a href='#in_sam45'>In-Sample Prediction Error </a> 
#  
#  35. <a href='#in_sample79'>Đường Cong Kiểm Định (Validation Curve)</a> 
#   
#  36. <a href='#in_sample793'>Xác Xuất Vỡ Nợ (PD) Và Tỷ Lệ Duyệt Khoản Vay</a> 
# 
#     
...
# 
# 
#  1. <a href='#out_of90'>Out-Of-Sample Predictor Error </a>    
#  
#  2. <a href='#out_of9'>Out-Of-Sample Confusion Matrix </a>    
#  
#  3. <a href='#out_of1'>Out-Of-Sample AU-ROC </a>    
#  
#  4. <a href='#out_of191'>Bootstrap AU-ROC </a>   
#  
#  5. <a href='#outofSam_1351'>Khoảng Tin Cậy Cho AUROC </a> 
#  
#  6. <a href='#out_of19'>Hệ Số Gini (Accuracy Ratio AR) </a>  
#  
#  7. <a href='#out_of191'>Bootstrap for Gini (Accuracy Ratio AR) </a>   
#  
#  8. <a href='#in_sam18'>CAP – Cumulative Accuracy Profile </a>   
#  
#  9. <a href='#out_of17'>Discriminatory Power Của Mô Hình Logistic </a> 
#  
#  10. <a href='#out_of177'>Lorenz Curve Monitoring </a>   
#  
#  11. <a href='#out_of178'>Điểm Brier and Calibration Curves </a>    
#  
#  12. <a href='#out_of1799'>The Information Entropy </a>  
#  
#  13. <a href='#insmap179'>Precision-Recall Curve </a>  
#  
#  14. <a href='#out_of3'>Sự Ổn Định Của Logistic </a>    
#  
#  15. <a href='#out_sample793'>Xác Xuất Vỡ Nợ (PD) Và Tỷ Lệ Duyệt Khoản Vay</a>
#  
#  16. <a href='#Valid_13'>So Sánh Độ Nhạy Của Mô Hình Logistic với các Model khác  </a> 
#  
# 
#  

# Phần này, bạn đọc có thể bỏ qua và đi thẳng vào phần chi tiết quy trình thực nghiệm Dự án
# 
# 
# $$\Large \color{blue}{\textbf{Giới Thiệu Nhanh Về Khái Niệm Phân Tích Độ Nhạy Trong Academic}}$$
# 
# 
...
# 
# ![log%20fom.png](attachment:log%20fom.png)
# 
# 
...
# 
# 
# $$\Large \color{blue}{\textbf{Chi Tiết Quy Trình Thực Nghiệm Dự Án}}$$
# 
# 
# 
# 
